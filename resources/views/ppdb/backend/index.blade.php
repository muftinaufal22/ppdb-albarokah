...
@section('content')
    ...
    <div class="content-wrapper container-xxl p-0">
        <div class="content-body">
            <div class="row">
                {{-- Bagian Kartu Welcome --}}
                <div class="col-lg-6 col-md-12 col-sm-12">
                    {{-- PERUBAHAN 1: Menambahkan style background gradient hijau --}}
                    <div class="card card-congratulations" style="background: linear-gradient(118deg, #28c76f, #52c234);">
                        <div class="card-body text-center">
                            ...
                            {{-- PERUBAHAN 2: Mengubah bg-primary menjadi bg-success agar ikon menjadi hijau --}}
                ...
                {{-- Bagian Statistik untuk Role PPDB --}}
