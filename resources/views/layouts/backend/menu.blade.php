<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        ...
        {{-- MENU BARU UNTUK PRESTASI DAN STRUKTUR ORGANISASI --}}
<li class=" nav-item">
    <a class="d-flex align-items-center" href="#"><i data-feather="globe"></i>
        <span class="menu-title text-truncate" data-i18n="Pencapaian">Website</span>
    </a>
    <ul class="menu-content">
        <li class="nav-item {{ (request()->is('backend-prestasi*')) ? 'active' : '' }}">
            <a class="d-flex align-items-center" href=" {{route('backend-prestasi.index')}} "><i
                    data-feather="circle"></i>
                <span class="menu-item text-truncate" data-i18n="Basic">Prestasi</span>
            </a>
        </li>
       <li class="nav-item {{ (request()->is('backend-struktur-organisasi*')) ? 'active' : '' }}">
                <a class="d-flex align-items-center" href=" {{route('backend-struktur-organisasi.index')}} "><i
                        data-feather="circle"></i>
                    <span class="menu-item text-truncate" data-i18n="Basic">Struktur Organisasi</span>
                </a>
            </li>
    </ul>
</li>
